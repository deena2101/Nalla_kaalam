...
```mermaid
graph TD
    A[🧑 User Lands on Altar] --> B[🎛️ Malayalam Soundboard & Kavadi Board]
    B --> C[📸 Upload Photo / Pick Avatar]
    C --> D[✨ Apply Chandanam & Thilakam Filter]
    D --> E[📅 Enter DOB & Hilarious Life Milestones]
    E --> F[🔮 Planetary Calculation Ritual]
    F -->|Audio Clatter & Stingers| G[☁️ Staged Planet Logs: ശനി Offline, ചന്ദ്രൻ സംശയത്തിൽ]
    G --> H[📜 Official NALLA KAALAM™ Certificate]
    H --> I[📊 6 Roast Pillars + Meme Level]
    H --> J[⚠️ പ്രധാന ദോഷം & പരിഹാരം]
    H --> K[👴 Savage Ammavan WhatsApp Voice Note]
    H --> L[📥 Download High-Res PNG Card + Confetti]
```
